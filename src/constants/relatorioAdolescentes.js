...
export default function RelatorioAdolescentes({data}){
    return (
        <View style={{gap: 10}}>
            ...
            <ListaCondicoes titulo='Apresenta as seguintes características sociais' lista={data.caracteristicasSociais}/>
            <RelText campo='Atividades favoritas' data={data.atividadesFavoritas}/>
