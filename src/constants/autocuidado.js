        ...
        <>
            ...
            <View style={styles.inputArea}>
                ...
                <Seletor
                    ...
                    aoMudar={value=>setPaciente(prev => ({...prev, atrapalhaComHigiene: value}))}
                    lista={simOuNao}
                />
                <Text style={styles.normal}>Veste-se sozinho?</Text>
                <Seletor
                    selecionado={paciente.vesteSozinho}
                    aoMudar={value=>setPaciente(prev => ({...prev, vesteSozinho: value}))}
                    lista={difAutocuidado}
                />
                <Text style={styles.normal}>Amarra os cadarços sozinho?</Text>
                <Seletor
                    selecionado={paciente.amarraCadarcos}
                    aoMudar={value=>setPaciente(prev => ({...prev, amarraCadarcos: value}))}
                    lista={difAutocuidado}
                />
            </View>
        </>
